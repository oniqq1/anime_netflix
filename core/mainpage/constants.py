ANIME_PLAYERS = {
    ...
    "Steins;Gate: Kyoukaimenjou no Missing Link": {
        "player_main": "https://www.youtube.com/embed/j7MIGCfyusk?si=bvcVJwK8aztHv1Vr"
    }
}
...
ANIME_DEFAULTS = {
    ...
    "Steins;Gate: Kyoukaimenjou no Missing Link": {
        ...
        "Просим прощения за то, что плеер - ютуб видео. К сожалению, в открытом доступе не было нормального варианта."
        ),
    }
}
